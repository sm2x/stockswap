...
<ul class="nav secondary-nav language-dropdown pull-right">
	<li class="dropdown dropdown-btn js-language-dropdown">
		...
		<ul class="dropdown-menu dropdown-menu-dark" role="menu">
			...
			<%--
            <li><a class="js-language-link" title="English" data-lang-code="us" href="${currentURL+'?lang=us'}">
				<img class="" src="${resource(plugin: 'kickstart', dir: 'images/flags',file: 'us.png')}"/>
				<g:message code="language.us" default="us"/> ${currentlURL }
			</a></li>
